package woodspring.springz.config;
...
@Configuration
@ComponentScan({"woodspring.springz"})
@EnableJpaRepositories(basePackages = "woodspring.springz", //.repository",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "woodspring.springz.dto" });
